...
| Agent service (OpenAI-compatible loop) | [02-agent-service.md](02-agent-service.md) | `apps/agent` |
...
Contract-level decisions and superseding changes are recorded in [CHANGELOG.md](CHANGELOG.md).
